...
namespace Breaddog.SaveManagement
{
    ...
    {
        [Tooltip("ƒанные будут предпочтительно сохранены р€дом с игрой")]
        PreferDefault,
        [Tooltip("ƒанные будут предпочтительно сохранены в месте, которое не удал€етс€ при удалении игры")]
        PreferPersistent
    }
