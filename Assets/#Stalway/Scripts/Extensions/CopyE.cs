...
namespace Breaddog.Extensions
{
    public static class CopyE
    {
        ...
        {
            return InternalDeepCopy(originalObject, new Dictionary<Object, Object>(new ReferenceEqualityComparer()));
        }
        private static Object InternalDeepCopy(Object originalObject, IDictionary<Object, Object> visited)
        {
