...
{
    public class StorageDrawerItem : MonoBehaviour
    {
        ...
        public StoredItem CurrentItem { get; protected set; }

        protected Asset<Sprite>? spriteAsset;
        protected bool async;


        public virtual void Initialize(bool async = false)
        {
            this.async = async;
