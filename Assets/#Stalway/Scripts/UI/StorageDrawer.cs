...
{
    public class StorageDrawer : MonoBehaviour
    {
        [Range(0, 20)]
        ...
        public StorageDrawerCell CellPrefab;
        public StorageDrawerItem ItemPrefab;
        [Space, FromAddressables]
        ...
        protected uint currentFrames;
        protected GridLayoutGroup cellsGrid;

        protected readonly List<StorageDrawerCell> cells = new(64);
        protected readonly List<StorageDrawerItem> items = new(64);
        ...
        private async UniTask UpdateInventory()
        {
            ...
            try
            {
                ...
                {
                    cells[i].SetState(storage.Places.RawData[i] == Storage.defaultIndex ? StorageCellState.Free : StorageCellState.Placed);
                }
        ...
        protected virtual void UpdatePosition(StorageDrawerItem item, Storage storage = null)
        {
        ...
        public StorageDrawerCell GetCell(int x, int y, Storage storage = null)
        {
            storage ??= ObservingStorage;
        ...
        public void AddTestItem()
        {
            ...
            Entity.ObservingEntity.FindAbillity<AbillityInventory>().AddItem(TestItem);
        }
    }
}
